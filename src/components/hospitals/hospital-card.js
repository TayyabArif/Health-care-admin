...
export const HospitalCard = ({ hospital, ...rest }) => {
  ...
  >
    <CardContent>
      ...
      >
        ...
        />
         <IconButton
            edge="end"
            size="small"
            onClick={() => {handleClick(hospital._id)}}
          >
            <MoreVertIcon />
          </IconButton>
          {(isClick && id == hospital._id) &&
      ...
      {hospital.departments.map((data, index) => {
        return (
          <ul key = {index}>
            <li>{data}</li>
          </ul>
      ...
      >
        ...
        >
          ...
          <Typography
            ...
            variant="body2"
          >
            Avaialable Doctors {hospital.availableDoc}
          </Typography>
        </Grid>
        <Grid
          item
